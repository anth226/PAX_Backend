...
export class AdminAuthController {
  ...
  // @Post("/reset_password_code_check")
  // @ApiResponse({
  //   description: "Password reset success.",
  //   status: HttpStatus.OK,
  // })
  // async resetPasswordCodeVerification(
  //   @AdminUser() adminUser: AdminUserDto,
  //   @Query() query: LanguageDto,
  //   @Body(new DtoValidationPipe()) resetVerificationDto: ResetVerificationDto
  // ) {
  //   const passwordRest = await this.authService.resetPasswordCodeCheck(
