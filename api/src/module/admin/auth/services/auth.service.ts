    ...
    try {
      ...
      const user = await this.adminUserRepository.findOne({
        ...
        relations: [
          ...
          "employee.officeId.officetypeId",
          "roles",
          "roles.permissions",
          "role",
        ],
      ...
      return {
        ...
        name_en: user.employee["name_en"],
        name_bn: user.employee["name_bn"],
        email: user.email,
        employee_id: user.employee["id"],
        profile_pic: user.employee["photo"],
        designation_bn: user.employee["designationId"].name_bn,
        designation_en: user.employee["designationId"].name_en,
        office_type: user.employee["officeId"].officetypeId.priority,
        token,
        roles: [],
        role: [],
        center: resourceCenter || null,
      };
    } catch (error) {
